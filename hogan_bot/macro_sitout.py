...
# ---------------------------------------------------------------------------
# FOMC / CPI / NFP event calendar (2024-06 through 2026-12)
# ---------------------------------------------------------------------------
...
_CPI_DATES: list[str] = [
    ...
    # 2026 (source: bls.gov/schedule/news_release/cpi.htm)
    "2026-01-13", "2026-02-13", "2026-03-11", "2026-04-10",
    "2026-05-12", "2026-06-10", "2026-07-14", "2026-08-12",
    "2026-09-11", "2026-10-14", "2026-11-10", "2026-12-10",
]

# NFP (Non-Farm Payrolls / Employment Situation): ~first Friday of each month, 08:30 ET
_NFP_DATES: list[str] = [
    # 2024
    ...
    # 2026 (source: bls.gov/schedule/news_release/empsit.htm)

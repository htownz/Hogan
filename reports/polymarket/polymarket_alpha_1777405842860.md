...
- Recommendation: `research`
- Evidence score: `0.5596`
- Confidence: `0.3581`
- Recommended size: `$0.00`
- Fair-value source: `market_implied_only`
- Risk flags: `gamma_price_only, missing_clob_spread, non_positive_after_cost_ev`
- Thesis: Informational market; prediction-market crowd probability 0.32.

### 7. Will bitcoin hit $1m before GTA VI?
- Recommendation: `research`
- Evidence score: `0.5158`
- Confidence: `0.2063`
- Recommended size: `$0.00`
- Fair-value source: `unavailable`
- Risk flags: `fair_value_unavailable, gamma_price_only, long_horizon_price_target_requires_calibrated_fair_value, missing_clob_spread, non_positive_after_cost_ev`
...
- `#10` `open` `buy_no` entry=`0.4895` current=`0.4900` size=`$24.35` pnl=`$-0.01` will-bitcoin-hit-1m-before-gta-vi-872
- `#8` `open` `buy_yes` entry=`0.0135` current=`0.0135` size=`$25.00` pnl=`$0.00` will-bitcoin-hit-150k-by-june-30-2026
- `#9` `open` `buy_yes` entry=`0.0950` current=`0.0950` size=`$18.67` pnl=`$0.00` will-bitcoin-hit-150k-by-december-31-2026
...
- Total score: `0.5409`
- After-cost EV: `-0.0425`
- Crowd probability: `0.3200`
- Hogan probability: `n/a`
- Rationale: prediction-market crowd probability 0.32
- Target price: `$1`
- Reject reasons: `research_only_side, non_positive_ev`
...
- Message: what-will-happen-before-gta-vi YES probabilities sum to 5.36

### 2. mutually_exclusive_overpricing
- Severity: `1.0000`
- Market IDs: `1373744, 1541748, 666614, 965261, 556062`

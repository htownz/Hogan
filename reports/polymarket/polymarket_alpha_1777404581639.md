...
- Timestamp ms: `1777404581639`
- Candidates reviewed: `7`
- Arbitrage alerts: `22`
- Shadow marked open: `2`
- Shadow closed: `0`
- Shadow open exposure: `$43.67`
- Shadow unrealized PnL: `$0.00`
- Hogan BTC probability: `0.4590`
...
- Total score: `0.8500`
- After-cost EV: `0.4030`
- Crowd probability: `0.0135`
- Hogan probability: `0.4590`
- Rationale: Hogan 0.46 vs crowd 0.01

### 2. Will Bitcoin hit $150k by December 31, 2026?
- Side: `buy_yes`
- Decision: `shadow_trade`
- Total score: `0.7994`
- After-cost EV: `0.3215`
- Crowd probability: `0.0950`
- Hogan probability: `0.4590`
- Rationale: Hogan 0.46 vs crowd 0.10
...
- Total score: `0.5602`
- After-cost EV: `-0.0425`
- Crowd probability: `0.3050`
- Hogan probability: `n/a`
- Rationale: prediction-market crowd probability 0.30
- Reject reasons: `research_only_side, non_positive_ev`
...
- Decision: `reject`
- Total score: `0.4403`
- After-cost EV: `-0.0120`
- Crowd probability: `0.4895`
- Hogan probability: `0.4590`
- Rationale: Hogan 0.46 vs crowd 0.49
- Reject reasons: `non_positive_ev`
